...
% bandwidth
filename_mr_net = [filepath, 'MR_net'];
filename_tez_net = [filepath, 'Tez_net'];
...
fclose(fmr_net);
mrData_net = [mrDataTmp_net{1} mrDataTmp_net{2}./1024./1024./1024 mrDataTmp_net{3}./1024./1024./1024];
...
fclose(ftez_net);
tezData_net = [tezDataTmp_net{1} tezDataTmp_net{2}./1024./1024./1024 tezDataTmp_net{3}./1024./1024./1024];
...
xlabel('Query', 'FontSize', fontsize);
ylabel('Amount of Data (MB)', 'FontSize', fontsize);
